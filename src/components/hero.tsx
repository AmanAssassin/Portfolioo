      ...
      <div className="container mx-auto z-10 px-6 md:px-12 mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center md:text-left">
            <span className="inline-block text-gray-300 font-medium mb-4 text-sm sm:text-base">
              Hi, I'm Aman Maurya
            </span>
            
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 break-words">
              <AnimatedTextCycle 
                words={[
                ...
                interval={3000}
                className="inline-block max-w-full text-center sm:text-left text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600"
              />
            </h1>
            
            <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-8 max-w-2xl mx-auto md:mx-0">
